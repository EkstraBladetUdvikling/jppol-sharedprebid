...
!(function (u) {
  ...
  0: function (e, t, n) {
        ...
        if ('string' == typeof e) {
          ...
          if (0 < o)
            if (2 === o && 'number' == typeof e[0] && 'number' == typeof e[1])
              t.push(G(e));
            else for (var a = 0; a < o; a++) t.push(G(e[a]));
        }
        return t;
      }),
    ...
    var m,
      ...
      U = Boolean(w && window.console.info),
      B = Boolean(w && window.console.warn),
    ...
    function J() {
      Q() && x && console.error.apply(console, Y(arguments, 'ERROR:')),
        R.emit(S.EVENTS.AUCTION_DEBUG, { type: 'ERROR', arguments: arguments });
    }
    function Y(e, t) {
      return (
        (e = [].slice.call(e)),
    ...
    function ue(e, t) {
      var n = k.createTrackPixelIframeHtml(
          e,
          !1,
    ...
    function be() {
      if (
        window.googletag &&
        X(window.googletag.pubads) &&
        X(window.googletag.pubads().getSlots)
      )
        return !0;
    }
    ...
    function we(e) {
      ...
      if (ne(e) && ne(i))
        for (var o in i)
          ne(i[o])
            ? (e[o] || y(e, v({}, o, {})), we(e[o], i[o]))
            : ee(i[o]) && e[o]
            ? ee(e[o]) && (e[o] = e[o].concat(i[o]))
            : y(e, v({}, o, i[o]));
    ...
    var _ = Object(b.b)(
      ...
      function (t, e, n, r) {
        ...
        !t.getUserSyncs ||
          ...
          ((i = u.b.getConfig('userSync.filterSettings')),
          (o = t.getUserSyncs(
            {
      ...
      return e
        ? t
          ...
          : (Object(m.logWarn)(
            ...
            !1)
        : (Object(m.logWarn)('No adUnitCode was supplied to addBidResponse.'),
          !1);
      var i;
    }
    ...
    function j() {
      ...
      var n = {
        ...
        set auctionOptions(e) {
          !(function (e) {
            if (!p.isPlainObject(e))
              return p.logWarn('Auction Options must be an object'), !1;
  ...
  361: function (e, t, n) {
    ...
    var r = n(14),
      ...
      o = n(49);
    r(
      { target: 'String', proto: !0, forced: !n(364)('includes') },
      {
        includes: function (e, t) {
  ...
  37: function (e, t, n) {
    ...
    n.d(t, 'f', function () {
      ...
      (t.g = function (t, e) {
        ...
        if (
          Object(u.deepAccess)(t, 'native.image') &&
          (!Object(u.deepAccess)(t, 'native.image.height') ||
            !Object(u.deepAccess)(t, 'native.image.width'))
        )
          return !1;
        if (
          Object(u.deepAccess)(t, 'native.icon') &&
          (!Object(u.deepAccess)(t, 'native.icon.height') ||
            !Object(u.deepAccess)(t, 'native.icon.width'))
        )
          return !1;
        ...
        'click' === e.action
          ...
          : ((n = t.native && t.native.impressionTrackers),
            t.native &&
              ...
              Object(u.insertHtmlIntoIframe)(t.native.javascriptTrackers));
        return (n || []).forEach(u.triggerPixel), e.action;
      }),
      (t.e = function (i, o) {
        var a = {};
        Object(u.deepAccess)(o, 'nativeParams.rendererUrl')
          ? (i.native.rendererUrl = f(o.nativeParams.rendererUrl))
          : Object(u.deepAccess)(o, 'nativeParams.adTemplate') &&
            (i.native.adTemplate = f(o.nativeParams.adTemplate));
        var c =
          !1 !== Object(u.deepAccess)(o, 'nativeParams.sendTargetingKeys');
        return (
          Object.keys(i.native).forEach(function (e) {
            var t, n, r;
            'adTemplate' !== e &&
              ((t = s.NATIVE_KEYS[e]),
              (n = f(i.native[e])),
              Object(u.deepAccess)(
                o,
                'mediaTypes.native.'.concat(e, '.sendId')
              ) && (n = ''.concat(t, ':').concat(i.adId)),
              (r = Object(u.deepAccess)(
                o,
                'nativeParams.'.concat(e, '.sendTargetingKeys')
              )),
              t && n && ('boolean' == typeof r ? r : c) && (a[t] = n));
          }),
          a
        );
      }),
      (t.d = function (e, r) {
        ...
        r.native.hasOwnProperty('adTemplate') &&
          (i.adTemplate = f(r.native.adTemplate));
        r.native.hasOwnProperty('rendererUrl') &&
          (i.rendererUrl = f(r.native.rendererUrl));
        return (
          e.assets.forEach(function (e) {
            var t = Object(u.getKeyByValue)(s.NATIVE_KEYS, e),
              n = f(r.native[t]);
      ...
      (t.c = function (e, r) {
        var i = { message: 'assetResponse', adId: e.adId, assets: [] };
        return (
          Object.keys(r.native).forEach(function (e, t) {
            var n;
            'adTemplate' === e && r.native[e]
              ? (i.adTemplate = f(r.native[e]))
              : 'rendererUrl' === e && r.native[e]
              ? (i.rendererUrl = f(r.native[e]))
              : r.native[e] &&
                s.NATIVE_KEYS.hasOwnProperty(e) &&
                ((n = f(r.native[e])), i.assets.push({ key: e, value: n }));
          }),
          i
        );
      });
    ...
    n.d(t, 'b', function () {
      ...
      (t.k = function (e) {
            ...
            void 0 === i &&
              ...
              Q(y, function () {
                try {
                  ...
                  null != g &&
                    ((e = f
                      .filter(P.bind.call(j.adUnitsFilter, this, d))
                      .reduce(ee, {})),
                    g.apply(pbjs, [e, n, p]),
                    (g = null));
                } catch (e) {
        ...
        function C(n) {
                  ...
                  s =
                    ...
                    (u = {}),
                    {
                      addBidResponse: function (e, t) {
                        ...
                        var n = (function (e) {
                          ...
                          var c =
                            ...
                            f = d && d.renderer,
                            l = null;
                          !f || !f.url || (!0 === f.backupOnly && f.render)
                            ? !u ||
                              !u.url ||
                        ...
                        'video' === n.mediaType
                          ? (function (e, t, n, r) {
                              var i = !0,
                                ...
                                a =
                                  o &&
                                  Object(j.deepAccess)(o, 'mediaTypes.video'),
                      ...
                      adapterDone: function () {
                        var t,
                          e = i.getBidRequests(),
                          n = U.b.getConfig('auctionOptions');
                        c.add(this),
                          !n ||
                            P.isEmpty(n) ||
          ...
          function p(e) {
            var r = !0,
              i = U.b.getConfig('maxRequestsPerOrigin') || z;
            return (
          ...
          callBids: function () {
            ...
            P.logInfo('Bids Requested for Auction with id: '.concat(p), e),
              e.length < 1
                ...
                : Y.call({ dispatch: C, context: this }, e);
          },
      ...
      return (
        ...
        'video' === e &&
          ...
          !U.b.getConfig('cache.url') ||
            ...
            ((o = Object(j.parseUrl)(U.b.getConfig('cache.url'))),
            void 0 ===
              B()(i, function (e) {
  ...
  44: function (e, t, n) {
    ...
    var _ = n(0),
      U = n(5),
      B = [],
      x = Object.keys(U.TARGETING_KEYS).map(function (e) {
      ...
      d = function (e) {
        return (
          e &&
          ((e.status && !T()([U.BID_STATUS.RENDERED], e.status)) || !e.status)
        );
      };
    function R(e, r, t) {
      ...
      l =
        ...
        (N.getAllTargeting = function (e) {
                  ...
                  Object.keys(o.adserverTargeting)
                    ...
                    .reduce(function (e, t) {
                      var n = [o.adserverTargeting[t]],
                        r = j({}, t.substring(0, 20), n);
                      if (t !== U.TARGETING_KEYS.DEAL)
                        return [].concat(w(e), [r]);
                      var i = j(
                        {},
          ...
          p.map(function (t) {
            Object.keys(t).map(function (e) {
              t[e].map(function (e) {
                -1 === B.indexOf(Object.keys(e)[0]) &&
                  (B = Object.keys(e).concat(B));
              });
            });
          });
          var b = Object.keys(C({}, U.DEFAULT_TARGETING_KEYS, U.NATIVE_KEYS)),
            v = E.b.getConfig('targetingControls.allowTargetingKeys') || b;
          Array.isArray(v) &&
            0 < v.length &&
            (p = (function (e, r) {
              var i = C({}, U.TARGETING_KEYS, U.NATIVE_KEYS),
                o = Object.keys(i),
                a = {};
              Object(A.logInfo)(
    ...
    function F(t, e) {
      return e.map(function (e) {
        return j({}, ''.concat(e, '_').concat(t.bidderCode).substring(0, 20), [
  ...
  519: function (e, t, n) {
    n(14)({ target: 'Number', stat: !0 }, { isInteger: n(520) });
  },
  52: function (e, t, n) {
    var r = n(29);
    e.exports = r;
      ...
      if (
        (v &&
          ...
          j !== Object.prototype &&
            ...
            (I ||
              S(u) === j ||
              (A ? A(u, j) : 'function' != typeof u[_] && O(u, _, y)),
            E(u, f, !0, !0),
            I && (C[f] = y))),
        i == U &&
          g &&
        ...
        if (((s = { values: c(U), keys: o ? b : c('keys'), entries: c(B) }), a))
  ...
  69: function (e, t, n) {
    ...
    var E = Object(r.a)(),
      ...
      B = w.REQUEST_BIDS,
      x = w.SET_TARGETING,
      R = w.AD_RENDER_FAILED,
      k = O.AD_RENDER_FAILED_REASON,
      ...
      G = {
        bidWon: function (e) {
          ...
          return (
            !!T.contains(t, e) ||
            void T.logError('The "' + e + '" placement is not defined.')
          );
        },
      };
    function W(e, t, n) {
    ...
    Object(u.a)(),
      ...
      (E.libLoaded = !0),
      (E.version = 'v4.25.0'),
      T.logInfo('Prebid.js v4.25.0 loaded'),
      (E.adUnits = E.adUnits || []),
      (E.triggerUserSyncs = j);
    var H = {
    ...
    function J(e) {
      var n = m.a[e]().filter(
          T.bind.call(i.adUnitsFilter, this, m.a.getAdUnitCodes())
        ),
    ...
    (E.getAdserverTargetingForAdUnitCodeStr = function (e) {
      ...
      (E.setTargetingForGPTAsync = function (e, t) {
        ...
        T.logInfo('Invoking pbjs.setTargetingForGPTAsync', arguments),
          Object(i.isGptPubadsDefined)()
            ? ((n = p.a.getAllTargeting(e)),
              p.a.resetPresetTargeting(e, t),
              p.a.setTargetingForGPT(n, t),
              Object.keys(n).forEach(function (t) {
                Object.keys(n[t]).forEach(function (e) {
                  'hb_adid' === e &&
                    m.a.setStatusForBids(
                      n[t][e],
                      O.BID_STATUS.BID_TARGETING_SET
                    );
                });
              }),
              C.emit(x, n))
      ...
      (E.setTargetingForAst = function (e) {
        T.logInfo('Invoking pbjs.setTargetingForAn', arguments),
          p.a.isApntagDefined()
            ? (p.a.setTargetingForAst(e), C.emit(x, p.a.getAllTargeting()))
      ...
      (E.renderAd = function (e, t, n) {
        if (
          ...
          try {
            ...
            v
              ? ((v.ad = T.replaceAuctionPrice(v.ad, v.cpm)),
                (v.adUrl = T.replaceAuctionPrice(v.adUrl, v.cpm)),
                n &&
                  n.clickThrough &&
                  ((r = n.clickThrough),
                  (v.ad = T.replaceClickThrough(v.ad, r)),
                  (v.adUrl = T.replaceClickThrough(v.adUrl, r))),
                m.a.addWinningBid(v),
                C.emit(U, v),
                (i = v.height),
                (o = v.width),
                ...
                T.insertElement(d, e, 'body'),
                Object(S.c)(s)
                  ? Object(S.b)(s, v)
                  : (e === document && !T.inIframe()) || 'video' === c
                  ? ((f = 'Error trying to write ad. Ad render call ad id '.concat(
                      t,
                      ' was prevented from writing to the main document.'
                    )),
                    Y({ reason: D, message: f, bid: v, id: t }))
                  : a
                  ? (navigator.userAgent &&
                      -1 <
                    ...
                    T.callBurl(v))
                  : u
                  ? (((p = T.createInvisibleIframe()).height = i),
                    (p.width = o),
                    (p.style.display = 'inline'),
                    (p.style.overflow = 'hidden'),
                    (p.src = u),
                    T.insertElement(p, e, 'body'),
                    W(e, o, i),
                    T.callBurl(v))
                  : ((g = 'Error trying to write ad. No ad for bid response id: '.concat(
                      t
                    )),
                    Y({ reason: N, message: g, bid: v, id: t })))
              : ((b = 'Error trying to write ad. Cannot find ad by given id : '.concat(
                  t
                )),
                Y({ reason: M, message: b, id: t }));
          } catch (e) {
            var y = 'Error trying to write ad Id :'
              .concat(t, ' to the page:')
              .concat(e.message);
            Y({ reason: P, message: y, id: t });
          }
        else {
        ...
        T.logInfo('Invoking pbjs.removeAdUnit', arguments),
          e
            ? (T.isArray(e) ? e : [e]).forEach(function (e) {
                for (var t = E.adUnits.length - 1; 0 <= t; t--)
    ...
    (E.enableAnalytics = function (e) {
      ...
      (E.getConfig = l.b.getConfig),
      (E.setConfig = l.b.setConfig),
      (E.setBidderConfig = l.b.setBidderConfig),
      E.que.push(function () {
        return Object(o.a)();
      }),
          ...
          r &&
            ...
            (a = E.deepClone(e)).forEach(function (e) {
              e.bids = e.bids
                .filter(function (e) {
                  return (
                    m()(n, e.bidder) && (!N(t) || e.finalSource !== A.CLIENT)
                  );
                })
                .map(function (e) {
        ...
        t.length
          ? ((r = (n = u(
            ...
            r.forEach(function (t) {
              ...
              E.logMessage('CALLING BIDDER ======= '.concat(t.bidderCode)),
        ...
        if (void 0 === C[r]) {
          ...
          if (void 0 === o) {
            ...
            w.forEach(function (e) {
              ...
              e.bidders &&
                e.bidders.length &&
                ((t = e && e.bidders), e && m()(t, r) ? (j[r] = n) : a.push(n));
            }),
              a.forEach(function (e) {
                E.logError(
          ...
          buildRequests: function (e, r) {
            for (
              var n,
                ...
                u,
                a,
                p = y.b.getConfig('currency.adServerCurrency'),
                c = [],
                g = [
              ...
              for (
                ...
                (i = d[(s = g[n][0])] || d.params[s]) &&
                  ((d[s] = d.params[s] = null), (g[n][1] = i));
          ...
          interpretResponse: function (e, r) {
            for (
              var n,
                ...
                d,
                s,
                i = { banner: 1, vast_content: 1, vast_url: 1 },
                o = [],
                u = r.bids,
                a = e.body,
                p = 0;
              ...
              (s = 'banner' === (t = a[p]).response ? g.b : g.d),
                ...
                i[t.response] &&
                  ...
                  d.renderer ||
                    s !== g.d ||
                    'outstream' !==
                      I.deepAccess(d, 'mediaTypes.video.context') ||
                    ((n.renderer = f.a.install({
                      id: d.bidId,
                      url:
    ...
    279: function (e, r, a) {
        ...
        R = {
          ...
          buildRequests: function (e, r) {
            var t = e.map(N),
              n = I()(e, M),
              i = {};
            !0 === k.b.getConfig('coppa') && (i = { coppa: !0 }),
              n &&
                Object.keys(n.params.user)
                  ...
                  .forEach(function (e) {
                    var r,
                      a = _.convertCamelToUnderscore(e);
                    'segments' === e && _.isArray(n.params.user[e])
                      ? ((r = []),
            ...
            var m,
              f,
              y = I()(e, z),
              g = y ? parseInt(y.params.member, 10) : 0,
              v = e[0].schain,
              b = I()(e, W),
              h = {
                tags: A(t),
                user: i,
                sdk: { source: 'pbjs', version: '4.25.0' },
                schain: v,
              };
            return (
              b && (h.iab_support = { omidpn: 'Appnexus', omidpv: '4.25.0' }),
              0 < g && (h.member_id = g),
              s && (h.device = a),
              d && (h.app = o),
              k.b.getConfig('adpod.brandCategoryExclusion') &&
                (h.brand_category_uniqueness = !0),
              c.enabled &&
                ((h.debug = c),
                _.logInfo(
              ...
              r && r.uspConsent && (h.us_privacy = r.uspConsent),
              r &&
                r.refererInfo &&
                ((m = {
                ...
                (h.referrer_detection = m)),
              I()(e, J) &&
                e.filter(J).forEach(function (r) {
                  var e = (function (e, r) {
              ...
              e[0].userId &&
                (L(
                  (f = []),
                  _.deepAccess(e[0], 'userId.criteoId'),
                  'criteo.com',
                  null
                ),
                L(f, _.deepAccess(e[0], 'userId.netId'), 'netid.de', null),
                L(
                  f,
                  _.deepAccess(e[0], 'userId.idl_env'),
                  'liveramp.com',
                  null
                ),
                L(f, _.deepAccess(e[0], 'userId.tdid'), 'adserver.org', 'TDID'),
                f.length && (h.eids = f)),
              t[0].publisher_id && (h.publisher_id = t[0].publisher_id),
              (function (e, a) {
                var t = [],
                  n = {};
                !(function (e) {
                ...
                ('TRUE' !== _.getParameterByName('apn_test').toUpperCase() &&
                  !0 !== k.b.getConfig('apn_test')) ||
          ...
          interpretResponse: function (e, r) {
                      ...
                      (((a = (function (r, e, a) {
                        ...
                        if (e.rtb.video) {
                          ...
                          switch (
                            ...
                            case g.a:
                              var o = Object(y.getIabSubCategory)(
                                t.bidder,
                                e.brand_category_id
                              );
                          ...
                          var p = e.rtb[g.c],
                            c = e.viewability.config.replace(
                              'src=',
                              'data-src='
                            ),
                          ...
                          try {
                            var l, m;
                            e.rtb.trackers &&
                              ((l = e.rtb.trackers[0].impression_urls[0]),
                        ...
                        (t = n.ad_type) === g.d ? g.d : t === g.c ? g.c : g.b),
                      o.push(a));
                  }),
                e.debug &&
                  e.debug.debug_info &&
            ...
            return (
              e && e.error && (t += ': '.concat(e.error)), _.logError(t), o
            );
          },
          getMappingFileInfo: function () {
            return {
              url:
                'https://acdn.adnxs.com/prebid/appnexus-mapping/mappings.json',
              refreshInDays: 2,
            };
          },
          ...
          transformBidParams: function (a, e) {
            return (
              ...
              e &&
                ((a.use_pmt_rule =
                  'boolean' == typeof a.usePaymentRule && a.usePaymentRule),
                ...
                if (r)
                  for (
                    ...
                    try {
                      ...
                      if (p)
                        for (
                          var c = p.getElementsByTagName('script'), u = 0;
                          u < c.length && !s;
                          u++
                        ) {
                          var l = c[u];
                          l.getAttribute('data-src') == t &&
      ...
      function N(a) {
        ...
        (t.sizes = q(a.sizes)),
          ...
          (t.ad_types = []),
          (t.uuid = a.bidId),
          a.params.placementId
            ? (t.id = parseInt(a.params.placementId, 10))
            : (t.code = a.params.invCode),
          ...
          a.params.position &&
            (t.position = { above: 1, below: 2 }[a.params.position] || 0),
          a.params.trafficSourceCode &&
            (t.traffic_source_code = a.params.trafficSourceCode),
          ...
          a.params.publisherId &&
            (t.publisher_id = parseInt(a.params.publisherId, 10)),
          a.params.externalImpId &&
            (t.external_imp_id = a.params.externalImpId),
          _.isEmpty(a.params.keywords) ||
            (0 <
              (e = _.transformBidderParamKeywords(a.params.keywords)).length &&
              e.forEach(P),
            (t.keywords = e)),
          (a.mediaType !== g.c &&
            !_.deepAccess(a, 'mediaTypes.'.concat(g.c))) ||
            (t.ad_types.push(g.c),
            ...
            a.nativeParams &&
              ...
              Object.keys(n).forEach(function (e) {
                var r,
                  a = (l[e] && l[e].serverName) || l[e] || e,
                  t = l[e] && l[e].requiredParams;
                (i[a] = b({}, t, n[e])),
                  (a !== l.image.serverName && a !== l.icon.serverName) ||
                    !i[a].sizes ||
                    ((r = i[a].sizes),
                    (_.isArrayOfNums(r) ||
                      (_.isArray(r) &&
                  ...
                  a === l.privacyLink && (i.privacy_supported = !0);
              }),
              (r = i),
              (t[g.c] = { layouts: [r] })));
        var s = _.deepAccess(a, 'mediaTypes.'.concat(g.d)),
          o = _.deepAccess(a, 'mediaTypes.video.context');
        (t.hb_source = s && 'adpod' === o ? 7 : 1),
          (a.mediaType !== g.d && !s) || t.ad_types.push(g.d),
          (a.mediaType === g.d || (s && 'outstream' !== o)) &&
            (t.require_asset_url = !0),
          a.params.video &&
            ((t.video = {}),
            ...
            a.params.video.frameworks &&
              _.isArray(a.params.video.frameworks) &&
              (t.video_frameworks = a.params.video.frameworks)),
          a.renderer &&
            (t.video = b({}, t.video, { custom_renderer_present: !0 })),
          a.params.frameworks &&
            _.isArray(a.params.frameworks) &&
            (t.banner_frameworks = a.params.frameworks);
        var d = I()(p.a.getAdUnits(), function (e) {
          return a.transactionId === e.transactionId;
        });
        return (
          d && d.mediaTypes && d.mediaTypes.banner && t.ad_types.push(g.b),
      ...
      function J(e) {
        return (
          e.mediaTypes &&
          e.mediaTypes.video &&
          e.mediaTypes.video.context === g.a
        );
      }
      function W(e) {
        var r = !1,
        ...
        return (
          a.frameworks &&
            _.isArray(a.frameworks) &&
            (r = w()(e.params.frameworks, 6)),
          !r &&
            t &&
            t.frameworks &&
            _.isArray(t.frameworks) &&
            (r = w()(e.params.video.frameworks, 6)),
          r
        );
      }
      function F(e, r, a) {
...
pbjsChunk(
  [295],
  {
    ...
    359: function (n, t, e) {
          ...
          iab: function (o, e, s) {
            ...
            var t = (function () {
                ...
                function e() {
                  t.getConsentData &&
                    t.getVendorConsents &&
                    (u.logInfo('Received all requested responses from CMP', t),
                    o(t, s));
                }
                return {
            ...
            u.isFn(r)
              ? (u.logInfo(
                ...
                1 === D
                  ? (r('getConsentData', null, t.consentDataCallback),
                    r('getVendorConsents', null, t.vendorConsentsCallback))
                  : 2 === D && r('addEventListener', D, n))
              : 1 === D &&
                window.$sf &&
                window.$sf.ext &&
              ...
              ? (u.logInfo(
                ...
                d('getVendorConsents', t.vendorConsentsCallback))
              : (u.logInfo(
                  'Detected CMP is outside the current iframe where Prebid.js is located, calling it now...'
                ),
                1 === D
                  ? (l('getConsentData', i, t.consentDataCallback),
                    l('getVendorConsents', i, t.vendorConsentsCallback))
                  : 2 === D && l('addEventListener', i, n));
            function d(o, a) {
              var n,
                t = s.adUnits,
                e = 1,
              ...
              Array.isArray(t) &&
                0 < t.length &&
                ((e = (n = u.getAdUnitSizes(t[0]))[0][0]), (i = n[0][1])),
            ...
            function l(n, i, t) {
              ...
              function e(n) {
                var t,
                  e = ''.concat(a, 'Return'),
                  o =
                    'string' == typeof n.data && f()(n.data, e)
                      ? JSON.parse(n.data)
                      : n.data;
                o[e] &&
                  o[e].callId &&
                  ((t = o[e]),
                  void 0 !== c[t.callId] &&
                    c[t.callId](t.returnValue, t.success));
              }
              2 === D
                ? ((window[a] = function (n, t, e, o) {
                    var a = p({}, r, {
                      command: n,
                      version: t,
                      parameter: o,
                  ...
                  window[a](n, D, t))
                : ((window[a] = function (n, t, e) {
                    var o = p({}, r, { command: n, parameter: t, callId: s });
      ...
      function A(e, n) {
        'static' === d &&
          2 === (D = e.getConsentData ? 1 : e.getTCData ? 2 : 0) &&
          (e = e.getTCData);
        var t =
          1 === D
            ? function (n) {
            ...
            ? function () {
                var n =
                    e && 'boolean' == typeof e.gdprApplies ? e.gdprApplies : g,
                  t = e && e.tcString;
                return !('boolean' == typeof n && (!0 !== n || u.isStr(t)));
              }
            : null;
        w.definedInConfig && 2 === D
          ? u.logWarn("'allowAuctionWithoutConsent' ignored for TCF 2")
          : w.definedInConfig ||
            1 !== D ||
            u.logInfo(
          ...
          u.isFn(t)
            ? t(e)
              ? P('CMP returned unexpected value during lookup process.', n, e)
              : (clearTimeout(n.timer), I(e), S(null, n))
            : P(
      ...
      function I(n) {
        1 === D
          ...
          : ((C = {
            ...
            n &&
              n.addtlConsent &&
              u.isStr(n.addtlConsent) &&
              (C.addtlConsent = n.addtlConsent)),
          (C.apiVersion = D),
      ...
      function S(n, t, e) {
        ...
        !1 === t.haveExited &&
          ...
          n
            ? w.value && 1 === D
              ? (u.logWarn(n + " 'allowAuctionWithoutConsent' activated.", e),
                i.apply(o, a))
              : (u.logError(
      ...
      function _(n) {
        (n = n && (n.gdpr || n.usp ? n.gdpr : n)) && 'object' === c(n)
          ? (u.isStr(n.cmpApi)
              ? (d = n.cmpApi)
              : ((d = v),
                u.logInfo(
...
pbjsChunk(
  [1],
  {
    ...
    380: function (module, __webpack_exports__, __webpack_require__) {
      ...
      var __WEBPACK_IMPORTED_MODULE_0__src_adloader_js__ = __webpack_require__(
          40
        ),
        __WEBPACK_IMPORTED_MODULE_1__src_adapters_bidderFactory_js__ = __webpack_require__(
          1
        ),
        __WEBPACK_IMPORTED_MODULE_2__src_config_js__ = __webpack_require__(3),
        __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__ = __webpack_require__(
          2
        ),
        __WEBPACK_IMPORTED_MODULE_4__src_utils_js__ = __webpack_require__(0),
        __WEBPACK_IMPORTED_MODULE_5_core_js_pure_features_array_find_js__ = __webpack_require__(
          10
        ),
        __WEBPACK_IMPORTED_MODULE_5_core_js_pure_features_array_find_js___default = __webpack_require__.n(
          __WEBPACK_IMPORTED_MODULE_5_core_js_pure_features_array_find_js__
        ),
        __WEBPACK_IMPORTED_MODULE_6_criteo_direct_rsa_validate_build_verify_js__ = __webpack_require__(
          381
        ),
        __WEBPACK_IMPORTED_MODULE_6_criteo_direct_rsa_validate_build_verify_js___default = __webpack_require__.n(
          __WEBPACK_IMPORTED_MODULE_6_criteo_direct_rsa_validate_build_verify_js__
        ),
        __WEBPACK_IMPORTED_MODULE_7__src_storageManager_js__ = __webpack_require__(
          7
        );
      function _extends() {
        return (_extends =
      ...
      var GVLID = 91,
        ...
        spec = {
          ...
          buildRequests: function (t, e) {
            ...
            if (
              (_extends(e, {
                publisherExt: __WEBPACK_IMPORTED_MODULE_2__src_config_js__.b.getConfig(
                  'fpd.context'
                ),
                userExt: __WEBPACK_IMPORTED_MODULE_2__src_config_js__.b.getConfig(
                  'fpd.user'
                ),
                ceh: __WEBPACK_IMPORTED_MODULE_2__src_config_js__.b.getConfig(
                  'criteo.ceh'
                ),
              }),
              ...
              (s = publisherTagAvailable()
                ? ((i = (r = new Criteo.PubTag.Adapters.Prebid(
                    PROFILE_ID_PUBLISHERTAG,
                    ADAPTER_VERSION,
                    t,
                    e,
                  ...
                  r.buildCdbRequest())
                : ((i = buildCdbUrl((a = buildContext(t, e)))),
                  buildCdbRequest(a, t, e))))
            )
              return { method: 'POST', url: i, data: s, bidRequests: t };
          },
          interpretResponse: function (t, s) {
            ...
            return (
              e &&
                e.slots &&
                __WEBPACK_IMPORTED_MODULE_4__src_utils_js__.isArray(e.slots) &&
                e.slots.forEach(function (e) {
                  var t = __WEBPACK_IMPORTED_MODULE_5_core_js_pure_features_array_find_js___default()(
                      s.bidRequests,
                      function (t) {
                        return (
                          t.adUnitCode === e.impid &&
                          (!t.params.zoneId ||
                            parseInt(t.params.zoneId) === e.zoneid)
                        );
                      }
                    ),
                    r = t.bidId,
                    i = {
                      ...
                      adId:
                        e.bidId ||
                        __WEBPACK_IMPORTED_MODULE_4__src_utils_js__.getUniqueIdentifierStr(),
                      cpm: e.cpm,
                      currency: e.currency,
                      netRevenue: !0,
                      ttl: e.ttl || 60,
      ...
      function buildCdbUrl(t) {
        ...
        return (
          ...
          (e += '&wv=' + encodeURIComponent('4.25.0')),
        ...
        var i,
          s = {
            ...
            slots: e.map(function (t) {
              ...
              return (
                t.params.zoneId && (r.zoneid = t.params.zoneId),
                t.fpd && t.fpd.context && (r.ext = t.fpd.context),
                t.params.ext && (r.ext = _extends({}, r.ext, t.params.ext)),
                t.params.publisherSubId &&
                  (r.publishersubid = t.params.publisherSubId),
                t.params.nativeCallback ||
                __WEBPACK_IMPORTED_MODULE_4__src_utils_js__.deepAccess(
                  t,
                  'mediaTypes.'.concat(
                    __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__.c
                  )
                  ...
                  ? ((r.native = !0),
                    checkNativeSendId(t) ||
                      __WEBPACK_IMPORTED_MODULE_4__src_utils_js__.logWarn(
                        LOG_PREFIX +
                  ...
                  : (r.sizes = parseSizes(retrieveBannerSizes(t), parseSize)),
                hasVideoMediaType(t) &&
                  (((e = {
        ...
        if (
          (['skip', 'placement', 'playbackmethod'].forEach(function (t) {
            void 0 ===
              ...
              ((r = !1),
              __WEBPACK_IMPORTED_MODULE_4__src_utils_js__.logError(
                'Criteo Bid Adapter: params.video.' + t + ' is required'
              ));
          }),
          r)
        ) {
      ...
      function tryGetCriteoFastBid() {
        try {
          var fastBidStorageKey = 'criteo_fast_bid',
            hashPrefix = '// Hash: ',
            fastBidFromStorage = storage.getDataFromLocalStorage(
              fastBidStorageKey
            ),
            ...
            publisherTagHash,
            publisherTag;
          null !== fastBidFromStorage &&
            ((firstLineEndPosition = fastBidFromStorage.indexOf('\n')),
            (firstLine = fastBidFromStorage
              .substr(0, firstLineEndPosition)
              .trim()),
            firstLine.substr(0, hashPrefix.length) !== hashPrefix
              ? (__WEBPACK_IMPORTED_MODULE_4__src_utils_js__.logWarn(
                  'No hash found in FastBid'
                ),
                storage.removeDataFromLocalStorage(fastBidStorageKey))
              : ((publisherTagHash = firstLine.substr(hashPrefix.length)),
                ...
                Object(
                  ...
                  ? (__WEBPACK_IMPORTED_MODULE_4__src_utils_js__.logInfo(
    ...
    381: function (t, e, r) {
      ...
      e.verify = function (t, e, r, i) {
        var s = new _.BigInteger(_.b64toHex(e)),
          a = new _.BigInteger(_.b64toHex(r)),
          o = s.modPowInt(i, a);
    ...
    382: function (t, e, r) {
      ...
      var s =
        ((T.prototype.toHexString = function () {
          ...
          if (0 < i--)
            for (
              s < this.DB && 0 < (t = this[i] >> s) && ((e = !0), (r = c(t)));
              0 <= i;
        ...
        (T.prototype.divRemTo = function (t, e, r) {
          ...
          if (!(i.t <= 0)) {
            ...
            var a = b(),
              ...
              n = this.DB - P(i[i.t - 1]);
            0 < n
              ? (i.lShiftTo(n, a), s.lShiftTo(n, r))
              : (i.copyTo(a), s.copyTo(r));
            var p = a.t,
              c = a[p - 1];
            if (0 != c) {
              var d = c * (1 << this.F1) + (1 < p ? a[p - 2] >> this.F2 : 0),
                u = this.FV / d,
                h = (1 << this.F1) / d,
                l = 1 << this.F2,
                f = r.t,
              ...
              for (
                a.dlShiftTo(v, m),
                  0 <= r.compareTo(m) && ((r[r.t++] = 1), r.subTo(m, r)),
                  T.ONE.dlShiftTo(p, m),
                  m.subTo(a, a);
                a.t < p;
              ...
              for (; 0 <= --v; ) {
                var E =
                  r[--f] == c
                    ? this.DM
                    : Math.floor(r[f] * u + (r[f - 1] + l) * h);
                if ((r[f] += a.am(0, E, r, v, 0, p)) < E)
                  for (a.dlShiftTo(v, m), r.subTo(m, r); r[f] < --E; )
                    r.subTo(m, r);
              }
              null != e && (r.drShiftTo(p, e), o != _ && T.ZERO.subTo(e, e)),
                (r.t = p),
                r.clamp(),
                0 < n && r.rShiftTo(n, r),
                o < 0 && T.ZERO.subTo(r, r);
            }
          }
        }),
        ...
        (T.prototype.am2 = function (t, e, r, i, s, a) {
          for (var o = 32767 & e, _ = e >> 15; 0 <= --a; ) {
            var n = 32767 & this[t],
              ...
              c = _ * n + p * o;
            (s =
              ((n = o * n + ((32767 & c) << 15) + r[i] + (1073741823 & s)) >>>
                30) +
              (c >>> 15) +
              _ * p +
              (s >>> 30)),
          ...
          a < 0 ||
            (r =
              0 == r
                ? ((e += c(a >> 2)), (i = 3 & a), 1)
                : 1 == r
                ? ((e += c((i << 2) | (a >> 4))), (i = 15 & a), 2)
                : 2 == r
                ? ((e += c(i)), (e += c(a >> 2)), (i = 3 & a), 3)
                : ((e += c((i << 2) | (a >> 4))), (e += c(15 & a)), 0));
        }
      ...
      (e.nbv = f),
        ...
        (i =
          'Microsoft Internet Explorer' == navigator.appName
            ? ((s.prototype.am = s.prototype.am2), 30)
            : 'Netscape' != navigator.appName
            ? ((s.prototype.am = s.prototype.am1), 26)
            : ((s.prototype.am = s.prototype.am3), 28)),
        (s.prototype.DB = i),
      ...
      var i =
        ((D.hash = function (t) {
          ...
          for (
            ...
            for (var _ = 0; _ < 16; _++)
              a[o][_] =
                (t.charCodeAt(64 * o + 4 * _) << 24) |
                (t.charCodeAt(64 * o + 4 * _ + 1) << 16) |
                (t.charCodeAt(64 * o + 4 * _ + 2) << 8) |
                (t.charCodeAt(64 * o + 4 * _ + 3) << 0);
          }
          var n = (8 * (t.length - 1)) / Math.pow(2, 32),
            p = (8 * (t.length - 1)) >>> 0;
          for (
            a[s - 1][14] = Math.floor(n), a[s - 1][15] = p, o = 0;
            o < s;
            o++
          ) {
            ...
            for (d = 16; d < 64; d++)
              c[d] =
                (D.q1(c[d - 2]) + c[d - 7] + D.q0(c[d - 15]) + c[d - 16]) >>> 0;
            for (
              var u = r[0],
                h = r[1],
                l = r[2],
              ...
              var b = T + D.z1(v) + D.Ch(v, m, E) + e[d] + c[d],
                P = D.z0(u) + D.Maj(u, h, l);
              (T = E),
                (E = m),
                (m = v),
                (v = (f + b) >>> 0),
...
pbjsChunk(
  [259],
  {
    ...
    447: function (e, r, n) {
      ...
      var O,
        ...
        w = {
          getGvlidForBidAdapter: function (e) {
            ...
            {
              var n;
              !(e = e || c.b.getCurrentBidder()) ||
                ((n = s.default.getBidAdapter(e)) &&
                  n.getSpec &&
                  (r = n.getSpec().gvlid));
            }
            return r;
          ...
          getGvlidForAnalyticsAdapter: function (e) {
            return (
              s.default.getAnalyticsAdapter(e) &&
              (s.default.getAnalyticsAdapter(e).gvlid || null)
            );
          },
        };
      function B(e) {
        ...
        if (e) {
          ...
          r =
            w.getGvlidForBidAdapter(t) ||
            w.getGvlidForUserIdModule(e) ||
            w.getGvlidForAnalyticsAdapter(t);
        }
        return r;
      }
      function V(r, e, n, t) {
      ...
      function H(e, r, n, t) {
        var o, a, i;
        (t = m({}, { hasEnforcementHook: !0 })),
          Object(l.hasDeviceAccess)()
            ? (o = s.gdprDataHandler.getConsentData()) &&
              o.gdprApplies &&
              2 === o.apiVersion
              ? ((r =
                  (a = c.b.getCurrentBidder()) &&
                  a != n &&
                  s.default.aliasRegistry[a] === n
                    ? B(a)
                    : B(n) || r),
                V(O, o, (i = n || a), r)
                  ? (t.valid = !0)
                  : (i && l.logWarn('TCF2 denied device access for '.concat(i)),
                    (t.valid = !1),
                    P.push(i)))
              : (t.valid = !0)
            : (l.logWarn('Device access is disabled by Publisher'),
              (t.valid = !1)),
          e.call(this, r, n, t);
      }
      function R(e) {
        for (
          var r,
            n,
            t = s.gdprDataHandler.getConsentData(),
            o = arguments.length,
            a = new Array(1 < o ? o - 1 : 0),
            i = 1;
          i < o;
          i++
        )
        ...
        t && t.gdprApplies && 2 === t.apiVersion
          ? ((n = B((r = c.b.getCurrentBidder()))),
            V(O, t, r, n)
              ? e.call.apply(e, [this].concat(a))
              : (l.logWarn('User sync not allowed for '.concat(r)), P.push(r)))
          : e.call.apply(e, [this].concat(a));
      }
      function T(e, r, t) {
        var n;
        t && t.gdprApplies && 2 === t.apiVersion
          ? ((n = r
            ...
            e.call(this, n, y(y({}, t), {}, { hasValidated: !0 })))
          : e.call(this, r, t);
      }
      function G(e, r) {
        for (
        ...
        o &&
          ...
          r.forEach(function (e) {
            e.bids = e.bids.filter(function (e) {
              ...
              return (
                t ||
                  (l.logWarn('TCF2 blocked auction for '.concat(r)), k.push(r)),
                t
              );
            });
          }),
      ...
      function U(e) {
        ...
        (C = r || (l.logWarn('TCF2: enforcing P1 and P2 by default'), E)),
          (O = o()(C, W)),
          (h = o()(C, I)),
          (j = o()(C, N)),
          (O = O || E[0]),
    ...
    679: function (e, d, n) {
      ...
      var o = n(13),
        ...
        u = {
          name: 'pubProvidedId',
          decode: function (e) {
            var d = e ? { pubProvidedId: e } : void 0;
            return (
              i.logInfo('PubProvidedId: Decoded value ' + JSON.stringify(d)), d
            );
          },
          getId: function (e) {
            var d = (e && e.params) || {},
              n = [];
            return (
              i.isArray(d.eids) && (n = n.concat(d.eids)),
              'function' == typeof d.eidsFunction &&
                (n = n.concat(d.eidsFunction())),
              { id: n }
            );
          },
        };
    ...
    685: function (e, r, a) {
        ...
        p = {
          bootstrapPlayer: function (e) {
            ...
            if (
              ...
              for (
                var a,
                  t = p.getRendererId('pubmatic', e.rendererCode),
              ...
              a
                ? a.bootstrap(r, i)
                : T.logWarn(
                    ''.concat(Y, ": Couldn't find a renderer with ").concat(t)
                  );
            } else
              T.logWarn(
                ''.concat(Y, ': No vastXml or vastUrl on bid, bailing...')
              );
          },
          newRenderer: function (e, r) {
            ...
            try {
              ...
              T.logWarn(
                ''.concat(Y, ': Error tying to setRender on renderer'),
                e
              );
            }
            return t;
      ...
      function U(e) {
        ...
        (e.params.adUnit = ''),
          ...
          (e.params.adSlot =
            ((r = e.params.adSlot),
            T.isStr(r) ? r.replace(/^\s+/g, '').replace(/\s+$/g, '') : ''));
        ...
        if (
          ...
          if (2 != (a = a[1].split('x')).length)
            return void T.logWarn(
              Y + 'AdSlot Error: adSlot not in required format'
            );
          (e.params.width = parseInt(a[0], 10)),
            (e.params.height = parseInt(a[1], 10));
        } else if (
          e.hasOwnProperty('mediaTypes') &&
          e.mediaTypes.hasOwnProperty(S.b) &&
        ...
        var r,
          ...
          s = {
            ...
            bidfloorcur: e.params.currency
              ? C('currency', e.params.currency)
              : A,
          };
        if (
          ((t = s),
          (i = e).params.deals &&
            (T.isArray(i.params.deals)
              ? i.params.deals.forEach(function (e) {
                  T.isStr(e) && 3 < e.length
                    ? (t.pmp || (t.pmp = { private_auction: 0, deals: [] }),
                      t.pmp.deals.push({ id: e }))
                    : T.logWarn(
                        Y +
              ...
              : T.logWarn(
                  Y + 'Error: bid.params.deals should be an array of strings.'
                )),
          e.hasOwnProperty('mediaTypes'))
        )
                                ...
                                ? (n = {
                                    ...
                                    img: {
                                      ...
                                      w:
                                        e[s].w ||
                                        e[s].width ||
                                        (e[s].sizes ? e[s].sizes[0] : x),
                                      h:
                                        e[s].h ||
                                        e[s].height ||
                                        (e[s].sizes ? e[s].sizes[1] : x),
                                      wmin:
                                        e[s].wmin ||
                                        e[s].minimumWidth ||
                                        (e[s].minsizes ? e[s].minsizes[0] : x),
                                      hmin:
                                        e[s].hmin ||
                                        e[s].minimumHeight ||
                                        (e[s].minsizes ? e[s].minsizes[1] : x),
                                      mimes: e[s].mimes,
                                      ext: e[s].ext,
                                    },
                                  })
          ...
          (r = {
            ...
            T.isArray(o) &&
              1 < o.length &&
              ((o = o.splice(1, o.length - 1)).forEach(function (e) {
                p.push({ w: e[0], h: e[1] });
              }),
              (r.format = p)),
            (s.banner = r);
        return (
          (function (t, i) {
            ...
            'function' != typeof i.getFloor ||
              P.b.getConfig('pubmatic.disableFloors') ||
              [S.b, S.d, S.c].forEach(function (e) {
                var r, a;
                t.hasOwnProperty(e) &&
                  ('object' !==
                    D(
                    ...
                    ((a = parseFloat(r.floor)),
                    (s = -1 == s ? a : Math.min(a, s))));
              });
            t.bidfloor && (s = Math.max(s, t.bidfloor));
            t.bidfloor = !isNaN(s) && 0 < s ? s : x;
          })(s, e),
          s.hasOwnProperty(S.b) ||
          s.hasOwnProperty(S.c) ||
          s.hasOwnProperty(S.d)
            ? s
            : x
        );
      }
      ...
      var b = {
          ...
          if (e && e.params) {
            ...
            if (e.params.hasOwnProperty('video')) {
              if (
                ...
                !T.isArray(e.params.video.mimes) ||
              ...
              if (
                !e.hasOwnProperty('mediaTypes') ||
                !e.mediaTypes.hasOwnProperty(S.d)
              )
                return (
                  T.logError(
                    ''.concat(
                      Y,
                      ': mediaTypes or mediaTypes.video is not specified. Rejecting bid: '
                    ),
                    e
                  ),
                  !1
              ...
              if (
                'outstream' === e.mediaTypes[S.d].context &&
                !T.isStr(e.params.outstreamAU) &&
                !e.hasOwnProperty('renderer') &&
                !e.mediaTypes[S.d].hasOwnProperty('renderer')
              )
                return (
                  T.logError(
                    ''.concat(
        ...
        buildRequests: function (e, r) {
          ...
          if (
            (e.forEach(function (e) {
              var r;
              ((s = T.deepClone(e)).params.adSlot = s.params.adSlot || ''),
                U(s),
                s.params.hasOwnProperty('video') ||
                (s.hasOwnProperty('mediaTypes') &&
                  s.mediaTypes.hasOwnProperty(S.c)) ||
                0 !== s.params.width ||
                0 !== s.params.height
                  ? ((v.pubId = v.pubId || s.params.publisherId),
                    ((v = (function (e, r) {
                      var a, t, i;
                      for (a in (r.kadpageurl || (r.kadpageurl = r.pageURL), N))
                        N.hasOwnProperty(a) &&
                          (t = e[a]) &&
                          ('object' === D((i = N[a])) && (t = i.f(t, r)),
                          T.isStr(t)
                            ? (r[a] = t)
                            : T.logWarn(
                                Y +
                    ...
                    s.params.hasOwnProperty('dctr') &&
                      T.isStr(s.params.dctr) &&
                      w.push(s.params.dctr),
                    s.params.hasOwnProperty('bcat') &&
                      T.isArray(s.params.bcat) &&
                      (O = O.concat(s.params.bcat)),
                    (r = z(s)) && E.imp.push(r))
                  : T.logWarn(
                      Y + 'Skipping the non-standard adslot: ',
                      s.params.adSlot,
                      JSON.stringify(s)
                    );
            }),
            ...
            return (
              ...
              (E.site.domain =
                ...
                o.hostname)),
              'object' === D(P.b.getConfig('content')) &&
                (E.site.content = P.b.getConfig('content')),
              'object' === D(P.b.getConfig('device')) &&
                (E.device = R(E.device, P.b.getConfig('device'))),
              T.deepSetValue(E, 'source.tid', v.transactionId),
              -1 !== window.location.href.indexOf('pubmaticTest=true') &&
                (E.test = 1),
              e[0].schain &&
                T.deepSetValue(E, 'source.ext.schain', e[0].schain),
              r &&
                r.gdprConsent &&
                (T.deepSetValue(
                  E,
              ...
              r &&
                r.uspConsent &&
                T.deepSetValue(E, 'regs.ext.us_privacy', r.uspConsent),
              !0 === P.b.getConfig('coppa') &&
                T.deepSetValue(E, 'regs.coppa', 1),
              (d = E),
              (c = e),
              (m = ''),
              0 < (p = w).length &&
              ...
              (g = E),
              (h = e),
              (f = T.deepAccess(h, '0.userIdAsEids')),
              T.isArray(f) && 0 < f.length && T.deepSetValue(g, 'user.eids', f),
              (b = E),
              0 <
                (y = (y = O)
                  .filter(function (e) {
                ...
                (T.logWarn(Y + 'bcat: Selected: ', y), (b.bcat = y)),
              'object' === D(P.b.getConfig('app')) &&
                ((E.app = P.b.getConfig('app')),
                (E.app.publisher = E.site.publisher),
                (E.app.ext = E.site.ext || x),
                'object' !== D(E.app.content) &&
                  (E.app.content = E.site.content || x),
                delete E.site),
              {
                method: 'POST',
                url:
                ...
                e.bid &&
                  ...
                  e.bid.forEach(function (r) {
                    ...
                    n.imp &&
                        ...
                        if (r.impid === e.id)
                          switch (
                            ...
                            case S.b:
                              break;
                            case S.d:
                              (a.width = r.hasOwnProperty('w')
                                ? r.w
                                : e.video.w),
                                (a.height = r.hasOwnProperty('h')
                                  ? r.h
                                  : e.video.h),
                                (a.vastXml = r.adm),
                                (function (e, r) {
                                  ...
                                  if (r.bidderRequest && r.bidderRequest.bids) {
                                    for (
                                      ...
                                      r.bidderRequest.bids[s].bidId ===
                                        e.requestId &&
                                        ((a = r.bidderRequest.bids[s].params),
                                        (t =
                              ...
                              !(function (e, r) {
                                if (
                                  ...
                                  if (
                                    ...
                                    r.mediaType = S.c;
                                    for (
                                      var t = 0, i = a.native.assets.length;
                                      t < i;
                                      t++
                                    )
                                      switch (a.native.assets[t].id) {
                                        case c.TITLE.ID:
                                          r.native.title =
                                            a.native.assets[t].title &&
                                            a.native.assets[t].title.text;
                                          break;
                                        case c.IMAGE.ID:
                                          r.native.image = {
                                            url:
                                              a.native.assets[t].img &&
                                              a.native.assets[t].img.url,
                                            height:
                                              a.native.assets[t].img &&
                                              a.native.assets[t].img.h,
                                            width:
                                              a.native.assets[t].img &&
                                              a.native.assets[t].img.w,
                                          };
                                          break;
                                        case c.ICON.ID:
                                          r.native.icon = {
                                        ...
                                        case c.DISPLAYURL.ID:
                                          r.native[g[a.native.assets[t].id]] =
                                            a.native.assets[t].data &&
                                            a.native.assets[t].data.value;
                                      }
                                    (r.native.clickUrl =
                      ...
                      r.adomain &&
                        0 < r.adomain.length &&
                        ((a.meta.advertiserDomains = r.adomain),
        ...
        getUserSyncs: function (e, r, a, t) {
          ...
          return (
            ...
            !0 === P.b.getConfig('coppa') && (i += '&coppa=1'),
            e.iframeEnabled
              ? [
                  {
                    type: 'iframe',
                    url:
                      'https://ads.pubmatic.com/AdServer/js/showad.js#PIX&kdntuid=1&p=' +
                      i,
                  },
                ]
              : [
        ...
        transformBidParams: function (e) {
          return T.convertTypes({ publisherId: 'string', adSlot: 'string' }, e);
        },
      };
  ...
  [6],
  {
    19: function (e, t, n) {
              ...
              : (o = (function (e, t) {
                  ...
                  if (n && e) {
                    ...
                    if (u.isStr(r)) {
                      var a,
                        i,
                        c = { id: r, atype: n.atype };
                      return (
                        !u.isFn(n.getUidExt) ||
                          ((a = n.getUidExt(e)) && (c.ext = a)),
                        (o.uids = [c]),
                        !u.isFn(n.getEidExt) ||
                          ((i = n.getEidExt(e)) && (o.ext = i)),
                        o
                      );
                    }
                  }
      ...
      var u = n(0),
        s = {
          ...
          idl_env: { source: 'liveramp.com', atype: 1 },
          lipb: {
            getValue: function (e) {
              return e.lipbid;
            },
          ...
          connectid: { source: 'verizonmedia.com', atype: 1 },
    ...
    877: function (e, t, n) {
      ...
      var v,
        ...
        x = 500,
        j = 0,
        k = { name: '_pbjs_userid_consent_data', expires: 30 },
        A = '_pbjs_id_optout',
        C = Object(m.a)('userid'),
        w = [],
        U = !1,
      ...
      function P(e, t) {
        ...
        try {
          ...
          n.type === D
            ...
            : n.type === E &&
              (C.setDataInLocalStorage(''.concat(n.name, '_exp'), a),
              C.setDataInLocalStorage(n.name, encodeURIComponent(r)),
              'number' == typeof n.refreshInSeconds &&
      ...
      function N(e, t) {
        var n,
          o,
          r = 1 < arguments.length && void 0 !== t ? t : void 0,
          a = r ? ''.concat(e.name, '_').concat(r) : e.name;
        try {
          e.type === D
            ? (n = C.getCookie(a))
            : e.type === E &&
              ('' === (o = C.getDataFromLocalStorage(''.concat(e.name, '_exp')))
                ? (n = C.getDataFromLocalStorage(a))
                : o &&
                  0 < new Date(o).getTime() - Date.now() &&
                  (n = decodeURIComponent(C.getDataFromLocalStorage(a)))),
      ...
      function q(e) {
        if (e && 'boolean' == typeof e.gdprApplies && e.gdprApplies) {
          ...
          if (
            1 === e.apiVersion &&
            !1 === l.deepAccess(e, 'vendorData.purposeConsents.1')
          )
            return;
          if (
            2 === e.apiVersion &&
            !1 === l.deepAccess(e, 'vendorData.purpose.consents.1')
          )
            return;
        }
        return 1;
      ...
      function R() {
        ...
        var r = -2,
          a = '_rdc'.concat(Date.now()),
          i = 'writeable';
        do {
          t = o.slice(r).join('.');
          var c = new Date(l.timestamp() + 1e4).toUTCString();
          C.setCookie(a, i, c, 'Lax', t, void 0),
            C.getCookie(a, void 0) === i
              ? ((n = !1),
                C.setCookie(
                  a,
                  '',
      ...
      function J(e, t) {
        var n = function () {};
        t &&
          (n = l.delayExecution(function () {
            clearTimeout(h), t();
          }, e.length)),
          e.forEach(function (t) {
            t.callback(function (e) {
              e
                ? (t.config.storage && P(t, e),
                  (t.idObj = t.submodule.decode(e, t.config)))
                : l.logInfo(
                    ''
                      .concat(S, ': ')
                      .concat(
      ...
      function H(e) {
        return Array.isArray(e) && e.length
          ? e
              ...
              .reduce(function (t, n) {
                return (
                  Object.keys(n.idObj).forEach(function (e) {
                    t[e] = n.idObj[e];
                  }),
                  t
                );
          ...
          (!(v = (function (e, n) {
            ...
            return t.hasValidated || q(n)
              ...
              : (l.logWarn(
                ...
                []);
          })(_, d.gdprDataHandler.getConsentData())).length ||
            ((t = v.filter(function (e) {
              ...
              (e && 0 < O
                ? ((n = !(r = !0)),
                  ...
                  l.logInfo(
                    ''
                      .concat(S, ' - auction delayed by ')
                      .concat(O, ' at most to fetch ids')
                  ),
                  (h = setTimeout(o, O)),
                  J(t, o))
                : c.a.on(f.a.EVENTS.AUCTION_END, function e() {
        ...
        z(function () {
          ...
          if (n.hasValidated || q(e)) {
            ...
            try {
              for (i.s(); !(r = i.n()).done; ) {
                var c = r.value;
                (0 < s.length && -1 === s.indexOf(c.submodule.name)) ||
                  (l.logInfo(
                    ''.concat(S, ' - refreshing ').concat(c.submodule.name)
                  ),
                  Q(c, e, t, !0),
      ...
      function Q(e, t, n, o) {
        var r, a, i, c, u, s, d;
        e.config.storage
          ? ((r = N(e.config.storage)),
            (c = !1),
            'number' == typeof e.config.storage.refreshInSeconds &&
              (c =
                (i = new Date(N(e.config.storage, 'last'))) &&
                Date.now() - i.getTime() >
                  1e3 * e.config.storage.refreshInSeconds),
            !r || c || o || ((d = t), null != (s = n) && s !== L(d))
              ? (a = e.submodule.getId(e.config, t, r))
              : 'function' == typeof e.submodule.extendId &&
                (a = e.submodule.extendId(e.config, r)),
            l.isPlainObject(a) &&
              (a.id && (P(e, a.id), (r = a.id)),
              'function' == typeof a.callback && (e.callback = a.callback)),
            r && (e.idObj = e.submodule.decode(r, e.config)))
          : e.config.value
          ? (e.idObj = e.config.value)
          : ((u = e.submodule.getId(e.config, t, void 0)),
            l.isPlainObject(u) &&
              ('function' == typeof u.callback && (e.callback = u.callback),
      ...
      function X() {
              ...
              ? e.reduce(function (e, t) {
                  return (
                    !t ||
                      l.isEmptyStr(t.name) ||
                      ((!t.storage ||
                        l.isEmptyStr(t.storage.type) ||
                        l.isEmptyStr(t.storage.name) ||
                        -1 === n.indexOf(t.storage.type)) &&
                        !l.isPlainObject(t.value) &&
                        (t.storage || t.value)) ||
                      e.push(t),
                    e
                  );
        ...
        o.length &&
          ...
          (_ = t
            .map(function (t) {
              ...
              return (
                (t.findRootDomain = R),
                e
                  ? { submodule: t, config: e, callback: void 0, idObj: void 0 }
                  : null
              );
            })
            .filter(function (e) {
          ...
          !U &&
            _.length &&
            (Object(u.a)().requestBids.before(B, 40),
            l.logInfo(
              ''
                .concat(S, ' - usersync config updated for ')
                .concat(_.length, ' submodules: '),
              _.map(function (e) {
      ...
      function Z(e) {
        (_ = []),
          ...
          -1 !==
            (w = [
              C.localStorageIsEnabled() ? E : null,
              C.cookiesAreEnabled() ? D : null,
            ].filter(function (e) {
              return null !== e;
            })).indexOf(D) && C.getCookie(A)
            ? l.logInfo(''.concat(S, ' - opt-out cookie found, exit module'))
            : -1 !== w.indexOf(E) && C.getDataFromLocalStorage(A)
            ? l.logInfo(
                ''.concat(S, ' - opt-out localStorage found, exit module')
              )
            : (e.getConfig(function (e) {
              ...
              (Object(u.a)().getUserIds = G),
              (Object(u.a)().getUserIdsAsEids = W),
              (Object(u.a)().refreshUserIds = $));
      }
