!(function (e) {
  ...
  0: function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', {
        ...
        if ('string' == typeof e) {
          ...
          if (o > 0)
            if (2 === o && 'number' == typeof e[0] && 'number' == typeof e[1])
              t.push(k(e));
            else for (var a = 0; a < o; a++) t.push(k(e[a]));
        }
        return t;
      }),
      ...
      (t.isValidMediaTypes = function (e) {
        ...
        if (e.video && e.video.context)
          return d()(['instream', 'outstream', 'adpod'], e.video.context);
        return !0;
      }),
      ...
      (t.isAllowZeroCpmBidsEnabled = function (e) {
        ...
        return (
          (t[e] && !0 === t[e].allowZeroCpmBids) ||
          (t.standard && !0 === t.standard.allowZeroCpmBids)
        );
      });
    var r = n(3),
      i = n(14),
    ...
    function W() {
      V() && T && console.warn.apply(console, z(arguments, 'WARNING:')),
        w.emit(O.EVENTS.AUCTION_DEBUG, {
          type: 'WARNING',
          arguments: arguments,
        });
    }
    ...
    function F() {
      V() && I && console.error.apply(console, z(arguments, 'ERROR:')),
        w.emit(O.EVENTS.AUCTION_DEBUG, {
          type: 'ERROR',
          arguments: arguments,
        });
              ...
              if (m && 0 !== m.length) {
                ...
                m.forEach(function (e) {
                  ...
                  m.forEach(function (t) {
                    ...
                    function o(t, n) {
                      d(e.code),
                        i.default.callBidderError(e.code, n, r),
                        ...
                        Object(y.logError)(
                          'Server call for '
                            ...
                            .concat(t, ' ')
                            .concat(n.status, '. Continuing without bids.')
                        ),
                        O();
                    }
                  });
            ...
            u(),
              o.b.runWithBidder(e.code, function () {
                p.a.emit(f.a.EVENTS.BIDDER_DONE, r),
                  t(b, r.gdprConsent, r.uspConsent);
              });
          }
        },
      });
  ...
  28: function (e, t, n) {
    ...
    function B(e, t) {
      ...
      !(function (e, t) {
        var n,
          i = Object(r.isAllowZeroCpmBidsEnabled)(e.bidderCode)
            ? e.cpm >= 0
            : e.cpm > 0;
    ...
    var k = function (e, t) {
      ...
      N = function (e) {
        return function (t, n) {
          return (e = e || k(t.mediaType, n)) === S.GRANULARITY_OPTIONS.AUTO
            ? t.pbAg
    ...
    function P(e, t) {
      ...
      if (
        (o[S.JSON_MAPPING.BD_SETTING_STANDARD] ||
          (o[S.JSON_MAPPING.BD_SETTING_STANDARD] = {}),
        o[S.JSON_MAPPING.BD_SETTING_STANDARD][
        ...
        if (
          ([i.UUID, i.CACHE_ID].forEach(function (e) {
            void 0 ===
              l()(a, function (t) {
                return t.key === e;
          ...
          void 0 ===
            ...
            a.push(
              n(i.CACHE_HOST, function (e) {
                return Object(r.deepAccess)(
                  e,
                  'adserverTargeting.'.concat(i.CACHE_HOST)
                )
                  ? e.adserverTargeting[i.CACHE_HOST]
                  : c.hostname;
              })
            );
        }
    ...
    function q(e, t, n, i) {
      ...
      return (
        (n.size = n.getSize()),
        Object(r._each)(o, function (o) {
          var a = o.key,
            c = o.val;
          if (
            (e[a] &&
              Object(r.logWarn)('The key: ' + a + ' is being overwritten'),
            Object(r.isFn)(c))
          )
            try {
              c = c(n, i);
          ...
          ((void 0 === t.suppressEmptyKeys || !0 !== t.suppressEmptyKeys) &&
            a !== S.TARGETING_KEYS.DEAL) ||
          (!Object(r.isEmptyStr)(c) && null != c)
            ? (e[a] = c)
            : Object(r.logInfo)(
      ...
      function u() {
        ...
        var i = {
          ...
          set priceGranularity(e) {
            c(e) &&
              ('string' == typeof e
                ? (this._priceGranularity = a(e) ? e : A.MEDIUM)
                ...
                ? Object.keys(e[n]).reduce(function (t, r) {
                    return (
                      'data' === r
                        ...
                        : Object(d.mergeDeep)(t, g({}, r, e[n][r])),
                      t
                    );
                  }, {})
                : e[n];
            ...
            .forEach(function (n) {
              Object.keys(e[n]).forEach(function (r) {
                'data' === r
                  ...
                  : 'object' !== b(e[n][r]) || Array.isArray(e[n][r])
                  ? Object(d.mergeDeep)(t, {
                      ext: {
          ...
          convertAdUnitFpd: function (e) {
            ...
            return (
              e.forEach(function (e) {
                e.fpd
                  ? (e.ortb2Imp
                      ? Object(d.mergeDeep)(e.ortb2Imp, T(e.fpd))
                      : (e.ortb2Imp = T(e.fpd)),
                    t.push(
                      (function (e) {
                        e.fpd;
      ...
      function C() {
        ...
        return (
          ...
          (t = t
            ...
            .filter(A.isUnusedBid)
            .filter(A.isBidNotExpired)),
          T(t, r.getOldestHighestCpmBid)
        );
      }
      ...
      return (
            ...
            window.googletag
              ...
              .forEach(function (e) {
                ...
                o.forEach(function (n) {
                  (n.code === e.getAdUnitPath() ||
                    n.code === e.getSlotElementId() ||
                    (Object(r.isFn)(t) && t(n.code))) &&
        ...
        (t.getAllTargeting = function (e) {
          var t =
            ...
            o = R(n, t)
              .concat(D(n, t))
              .concat(i.b.getConfig('enableSendAllBids') ? k(n, t) : s(n, t))
              .concat(P(n));
          o.map(function (e) {
          ...
          (c = null != u ? a.concat(u) : c || a),
            Array.isArray(c) && c.length > 0 && (o = d(o, c)),
            (o = y(o));
        ...
        i.b.getConfig('targetingControls', function (e) {
          null != Object(r.deepAccess)(e, O) &&
            null != Object(r.deepAccess)(e, j) &&
            Object(r.logError)(S);
        }),
        ...
        (t.getWinningBids = function (e) {
          ...
          return t
            ...
            .filter(function (e) {
              return Object(r.isAllowZeroCpmBidsEnabled)(e.bidderCode)
                ? e.cpm >= 0
                : e.cpm > 0;
            })
            .map(function (e) {
    ...
    e.exports = function (e, t, n, d, p, j, S) {
      ...
      if (
        ...
        if (
          ...
          for (T in A) (b || C || !(T in R)) && s(R, T, A[T]);
        else
          r(
            {
              target: t,
  ...
  8: function (e, t, n) {
    ...
    u.b.getConfig('s2sConfig', function (e) {
      e &&
        e.s2sConfig &&
        (_ = Object(r.isArray)(e.s2sConfig) ? e.s2sConfig : [e.s2sConfig]);
    });
    var U = {};
    var B = Object(s.b)(
      'sync',
    ...
    function q() {
      (w.s2STestingEnabled = !1),
        _.forEach(function (e) {
          e &&
            e.enabled &&
            e.bidders &&
            e.bidders.length &&
            P.push.apply(P, O(e.bidders));
        });
    }
    ...
    (w.makeBidRequests = Object(s.b)(
        ...
        0 === P.length && q(),
          _.forEach(function (t) {
            t &&
              t.enabled &&
              M(t) &&
              (A.calculateBidSources(t),
              A.getSourceBidderMap(e, P)[A.CLIENT].forEach(function (e) {
                f()(N, e) || N.push(e);
              }));
          }),
      ...
      (w.callBids = function (e, t, n, i, o, a, s) {
        if (t.length) {
          var d = m(
              t.reduce(
                function (e, t) {
                  return (
                    e[Number(void 0 !== t.src && t.src === T.S2S.SRC)].push(t),
                    e
                  );
                },
                [[], []]
            ...
            l.forEach(function (e) {
              ...
              u.b.runWithBidder(e.bidderCode, function () {
                Object(r.logMessage)('CALLING BIDDER'),
                  I.emit(T.EVENTS.BID_REQUESTED, e);
              });
              var d = Object(c.b)(
                  a,
                  o
      ...
      (w.registerBidAdapter = function (e, t) {
        ...
        e && t
          ? 'function' == typeof e.callBids
            ? ((C[t] = e),
              f()(a, 'video') && w.videoAdapters.push(t),
            ...
            try {
              var u,
                s = (function (e) {
                  var t = [];
                  return (
                    f()(w.videoAdapters, e) && t.push('video'),
  ...
  80: function (e, t, n) {
    ...
    Object(f.a)(),
      ...
      (j.libLoaded = !0),
      (j.version = 'v6.6.0'),
      Object(i.logInfo)('Prebid.js v6.6.0 loaded'),
      (j.installedModules = j.installedModules || []),
      (j.adUnits = j.adUnits || []),
    ...
    (j.getAdserverTargetingForAdUnitCodeStr = function (e) {
      ...
      (j.setTargetingForAst = function (e) {
        Object(i.logInfo)('Invoking pbjs.setTargetingForAn', arguments),
          s.d.isApntagDefined()
            ? (s.d.setTargetingForAst(e), A.emit(_, s.d.getAllTargeting()))
    ...
    (j.enableAnalytics = function (e) {
      ...
      (j.mergeConfig = c.b.mergeConfig),
      (j.mergeBidderConfig = c.b.mergeBidderConfig),
    ...
    188: function (e, t, r) {
        ...
        b = {
          ...
          buildRequests: function (e, t) {
            var r,
              ...
              o = i.user;
            'object' === l(m('app'))
              ? ((r = m('app') || {}), i.app && Object(a.mergeDeep)(r, i.app))
              : ((n = m('site') || {}),
                i.site && Object(a.mergeDeep)(n, i.site),
                n.page || (n.page = t.refererInfo.referer));
            var d = m('device') || {};
            (d.w = d.w || window.innerWidth),
              (d.h = d.h || window.innerHeight),
              (d.ua = d.ua || navigator.userAgent);
            var s = v(e, 'params.adxDomain') || 'adx.adform.net',
              u = v(e, 'params.pt') || v(e, 'params.priceType') || 'net',
              p = e[0].transactionId,
              f = v(e, 'params.test'),
              b = m('currency.adServerCurrency'),
              h = b && [b],
              j = v(e, 'userIdAsEids'),
              w = v(e, 'schain'),
                    ...
                    if (r) {
                      ...
                      if (
                        (s &&
                          s[0] &&
                          ((i = (s = s[0]).min_width || 0),
                          (a = ((s.ratio_height * i) / s.ratio_width) | 0)),
                        e.sizes)
                      ) {
                        var c = g(e.sizes);
                        (o = c[0]), (d = c[1]);
            ...
            return (
              f && ((O.is_debug = !!f), (O.test = 1)),
              void 0 !== Object(a.deepAccess)(t, 'gdprConsent.gdprApplies') &&
                ...
                Object(a.deepSetValue)(
                  O,
                  'regs.ext.gdpr',
                  1 & t.gdprConsent.gdprApplies
                )),
              t.uspConsent &&
                Object(a.deepSetValue)(O, 'regs.ext.us_privacy', t.uspConsent),
              j && Object(a.deepSetValue)(O, 'user.ext.eids', j),
              w && Object(a.deepSetValue)(O, 'source.ext.schain', w),
              {
                method: 'POST',
            ...
            if (e.body) {
              ...
              return r
                .map(function (e, t) {
                  var r = c[t];
                  if (r) {
                    var n = Object(a.deepAccess)(r, 'ext.prebid.type'),
                      o = {
                        requestId: e.bidId,
                        cpm: r.price,
                        creativeId: r.crid,
      ...
      function v(e, t) {
        for (var r, n = 0; n < e.length; n++)
          if ((r = Object(a.deepAccess)(e[n], t))) return r;
      }
      ...
      Object(n.registerBidder)(b),
        window.pbjs.installedModules.push('adfBidAdapter');
    },
  },
  [187]
);
            ...
            if (
              (e.tags &&
                e.tags.forEach(function (e) {
                  ...
                  if (
                    c &&
                    (Object(a.isAllowZeroCpmBidsEnabled)(i.bidderCode)
                      ? c.cpm >= 0
                      : c.cpm > 0) &&
                    ...
                    var u = (function (e, r, t) {
                      ...
                      if (r.rtb.video) {
                        switch (
                          ...
                          case o.a:
                            var u = Object(s.getIabSubCategory)(
                              i.bidder,
                              r.brand_category_id
                            );
                            d.meta = v({}, d.meta, {
      ...
      function q(e) {
        ...
        if (
          ...
          (e.mediaType === o.c ||
            ...
            (r.ad_types.push(o.c),
            0 === r.sizes.length && (r.sizes = M([1, 1])),
            e.nativeParams))
        ) {
          var u =
            ((i = e.nativeParams),
    ...
    380: function (n, t, e) {
      ...
      function D(n, t) {
        ...
        C.definedInConfig && 2 === v
          ...
          Object(o.isFn)(e)
            ? e(n)
              ? M('CMP returned unexpected value during lookup process.', t, n)
              : (clearTimeout(t.timer), k(n), h(null, t))
            : M(
      ...
      function O(n) {
        2 === v
          ? (Object(o.logWarn)('No response from CMP, continuing auction...'),
            k(void 0),
            h(null, n))
          : M('CMP workflow exceeded timeout threshold.', n);
      }
      ...
      function A(n) {
        (n = n && (n.gdpr || n.usp ? n.gdpr : n)) && 'object' === l(n)
          ? (Object(o.isStr)(n.cmpApi)
            ...
            w || pbjs.requestBids.before(j, 50),
            (w = !0))
          : Object(o.logWarn)(
...
pbjsChunk(
  [275],
  {
    ...
    462: function (e, t, o) {
      ...
      Object(i.c)('firstPartyData', f),
        b(),
        (Object(u.a)().refreshFpd = b),
    ...
    494: function (t, e, o) {
      ...
      var n = o(0),
        ...
        l = function (t) {
          ...
          if (!e.pbadslot)
            if (o)
              ...
              if (!Object(n.deepAccess)(e, 'adserver.adslot'))
        ...
        g = function (t, e) {
          ...
          for (
            var d = arguments.length, c = new Array(d > 2 ? d - 2 : 0), s = 2;
            s < d;
            s++
          )
            c[s - 2] = arguments[s];
        ...
        m = function (t) {
          (i = Object(n.pick)(t, [
            ...
            ? s || (Object(a.a)('makeBidRequests').before(g), (s = !0))
            : (Object(n.logInfo)(
                ''.concat('GPT Pre-Auction', ': Turning off module')
              ),
              (i = {}),
              Object(a.a)('makeBidRequests')
                .getHooks({
                  hook: g,
                })
                .remove(),
...
pbjsChunk(
  [166],
  {
    ...
    724: function (e, d, n) {
      ...
      var o = n(9),
        ...
        t = {
          ...
          decode: function (e) {
            ...
            return (
              Object(i.logInfo)(
                'PubProvidedId: Decoded value ' + JSON.stringify(d)
              ),
              d
            );
          },
          getId: function (e) {
            var d = (e && e.params) || {},
              n = [];
            return (
              Object(i.isArray)(d.eids) && (n = n.concat(d.eids)),
      ...
      Object(o.e)('userId', t),
        window.pbjs.installedModules.push('pubProvidedIdSystem');
    },
  },
  [723]
);
...
pbjsChunk(
  [163],
  {
    ...
    732: function (e, r, t) {
        ...
        k = {
          bootstrapPlayer: function (e) {
            ...
            if (
              ...
              for (
                var t,
                  i = k.getRendererId('pubmatic', e.rendererCode),
      ...
      function _(e, r) {
        Object(a.deepAccess)(e, 'placement') ||
          Object(a.logWarn)('Video.Placement param missing for ' + r);
      }
        ...
        buildRequests: function (e, r) {
          ...
          if (
            ...
            (c.site.publisher.id = o.pubId.trim()),
              ...
              (c.ext.wrapper.wv = 'prebid_prebid_6.6.0'),
...
pbjsChunk(
  [136],
  {
    ...
    808: function (o, e, t) {
      ...
      var c = Object(a.b)(887, 'pubCommonId'),
        u = 'cookie',
        l = 'html5',
        f = '_pubcid_optout',
        s = 'PublisherCommonId';
      ...
      function m(o, e) {
        ...
        if (e === l && c.hasLocalStorage()) {
          ...
          if (new Date(t).getTime() - Date.now() > 0)
            return c.getDataFromLocalStorage(o);
        }
      }
      ...
      function v() {
        return !!(
          (c.cookiesAreEnabled() && m(f, u)) ||
          (c.hasLocalStorage() && m(f, l))
        );
      }
      var g = {
        name: 'sharedId',
        ...
        decode: function (o, e) {
          if (!v())
            return (
              Object(n.logInfo)(' Decoded value PubCommonId ' + o),
              {
                pubcid: o,
              }
            );
        ...
        getId: function () {
          ...
          if (v()) Object(n.logInfo)('PubCommonId: Has opted-out');
          else {
            var t = i.coppaDataHandler.getCoppa();
            if (!t) {
              var r = o.params,
                a = (r = void 0 === r ? {} : r).create,
                c = void 0 === a || a,
                u = r.pixelUrl,
                l = e;
              if (!l) {
                ...
                l ||
                  (l =
                    c && Object(n.hasDeviceAccess)()
                      ? Object(n.generateUUID)()
                      : void 0);
              }
              var f = p(u, l);
              return {
        ...
        extendId: function () {
          ...
          if (v())
            return (
              Object(n.logInfo)('PubCommonId: Has opted-out'),
              {
                id: void 0,
              }
            );
        ...
        domainOverride: function () {
          for (
            ...
            if (
              (c.setCookie(n, '1', void 0, void 0, i),
              (e = c.getCookie(n)),
  ...
  [12],
  {
        ...
        (t.a = function (e) {
          ...
          return (
            e
              .filter(function (e) {
                return (
                  Object(o.isPlainObject)(e.idObj) &&
                  Object.keys(e.idObj).length
                );
              })
              .forEach(function (e) {
                Object.keys(e.idObj).forEach(function (n) {
                  Object(o.deepAccess)(e, 'config.bidders') &&
                    Array.isArray(e.config.bidders) &&
                    Object(o.deepAccess)(r, n + '.source') &&
                    t.push({
                      source: r[n].source,
    ...
    906: function (e, t, n) {
        ...
        var n = e.config.storage,
          o =
            'function' == typeof e.submodule.domainOverride
              ...
              : null;
        try {
          var r = Object(p.isPlainObject)(t) ? JSON.stringify(t) : t,
            a = new Date(Date.now() + 864e5 * n.expires).toUTCString();
          n.type === S
            ? (P.setCookie(n.name, r, a, 'Lax', o),
            ...
            : n.type === E &&
              (P.setDataInLocalStorage(''.concat(n.name, '_exp'), a),
              P.setDataInLocalStorage(n.name, encodeURIComponent(r)),
              'number' == typeof n.refreshInSeconds &&
                P.setDataInLocalStorage(
                  ''.concat(n.name, '_last'),
                  new Date().toUTCString()
                ));
        } catch (e) {
      ...
      function F(e) {
        ...
        try {
          if (e.type === S) t = P.getCookie(o);
          else if (e.type === E) {
            var r = P.getDataFromLocalStorage(''.concat(e.name, '_exp'));
            '' === r
              ? (t = P.getDataFromLocalStorage(o))
              : r &&
                new Date(r).getTime() - Date.now() > 0 &&
                (t = decodeURIComponent(P.getDataFromLocalStorage(o)));
          }
          'string' == typeof t &&
            '{' === t.trim().charAt(0) &&
            (t = JSON.parse(t));
      ...
      function J(e) {
        if (e && 'boolean' == typeof e.gdprApplies && e.gdprApplies) {
          ...
          if (
            1 === e.apiVersion &&
            !1 === Object(p.deepAccess)(e, 'vendorData.purposeConsents.1')
          )
            return !1;
          if (
            2 === e.apiVersion &&
            !1 === Object(p.deepAccess)(e, 'vendorData.purpose.consents.1')
          )
            return !1;
        }
        return !0;
      ...
      function W(e, t) {
        var n = function () {};
        t &&
          (n = Object(p.delayExecution)(function () {
            clearTimeout(h), t();
          }, e.length)),
          e.forEach(function (e) {
            e.callback(function (t) {
              t
                ? (e.config.storage && N(e, t),
      ...
      function z(e) {
        return Array.isArray(e) && e.length
          ? e
              .filter(function (e) {
                return (
                  Object(p.isPlainObject)(e.idObj) &&
                  Object.keys(e.idObj).length
                );
              })
              .reduce(function (e, t) {
            ...
            e.bids &&
              ...
              e.bids.forEach(function (e) {
                  ...
                  return Array.isArray(e) && e.length && t
                    ? e
                        .filter(function (e) {
                          return (
                            !e.config.bidders ||
                            !Object(p.isArray)(e.config.bidders) ||
                            y()(e.config.bidders, t)
                          );
                        })
                        .filter(function (e) {
                          return (
                ...
                Object.keys(n).length &&
                  ((e.userId = n), (e.userIdAsEids = Object(g.b)(n)));
              });
          });
      }
          ...
          if (n.length)
            if (e && k > 0) {
              ...
              c.a.on(l.a.EVENTS.AUCTION_END, function e() {
                c.a.off(l.a.EVENTS.AUCTION_END, e),
                  I > 0
                    ? setTimeout(function () {
                        W(n);
                      }, I)
      ...
      function K(e, t) {
        $(function () {
          ...
          if (n && 'string' == typeof Object(p.deepAccess)(n, 'uids.0.id')) {
            ...
            o.length >= 32 && o.length <= 150
              ? Object(p.isGptPubadsDefined)()
              ...
              : Object(p.logWarn)(
                  'User ID - Googletag Publisher Provided ID for '
                    .concat(w, ' is not between 32 and 150 characters - ')
                    .concat(o)
                );
          }
          e.call(this, t);
      ...
      function Y(e, t) {
        ...
        n || (n = []),
          $(function () {
            var e = s.gdprDataHandler.getConsentData(),
              o = Z(T, e),
              r = o.userIdModules;
            if (o.hasValidated || J(e)) {
              ...
              try {
                for (u.s(); !(i = u.n()).done; ) {
                  var d = i.value;
                  (n.length > 0 && -1 === n.indexOf(d.submodule.name)) ||
                    (Object(p.logInfo)(
                      ''.concat(D, ' - refreshing ').concat(d.submodule.name)
                    ),
                    ee(d, e, a, !0),
                    te(d),
                    j.length && q(j),
                    Object(p.isFn)(d.callback) && c.push(d));
                }
              } catch (e) {
                u.e(e);
              } finally {
      ...
      function ee(e, t, n, o) {
        if (e.config.storage) {
          ...
          !(function (e, t) {
            ...
            ? (r = e.submodule.getId(e.config, t, a))
            : 'function' == typeof e.submodule.extendId &&
              (r = e.submodule.extendId(e.config, t, a)),
            Object(p.isPlainObject)(r) &&
              (r.id && (N(e, r.id), (a = r.id)),
      ...
      function ne() {
        var e = (function (e, t, n) {
          return Array.isArray(e)
            ? e.reduce(function (e, t) {
                return (
                  !t ||
                    Object(p.isEmptyStr)(t.name) ||
                    (!t.storage ||
                    Object(p.isEmptyStr)(t.storage.type) ||
                    Object(p.isEmptyStr)(t.storage.name) ||
                    -1 === n.indexOf(t.storage.type)
                      ? Object(p.isPlainObject)(t.value)
                        ? e.push(t)
        ...
        if (e.length) {
          ...
          (T = t
            ...
            !_ &&
              T.length &&
              (Object(u.a)().requestBids.before(K, 40),
              Object(p.logInfo)(
                ''
                  .concat(D, ' - usersync config updated for ')
                  .concat(T.length, ' submodules: '),
                T.map(function (e) {
        ...
        (w = void 0),
          ...
          -1 !==
            (U = [
              ...
              return null !== e;
            })).indexOf(S) && P.getCookie(C)
            ? Object(p.logInfo)(
                ''.concat(D, ' - opt-out cookie found, exit module')
              )
            : -1 !== U.indexOf(E) && P.getDataFromLocalStorage(C)
            ? Object(p.logInfo)(
                ''.concat(D, ' - opt-out localStorage found, exit module')
              )
            : (e.getConfig('userSync', function (e) {
                var t = e.userSync;
                (w = t.ppid),
                  t &&
                    t.userIds &&
                    ((V = t.userIds),
                    (I = Object(p.isNumber)(t.syncDelay) ? t.syncDelay : 500),
                    (k = Object(p.isNumber)(t.auctionDelay)
                      ? t.auctionDelay
                      : 0),
                    ne());
              }),
              (Object(u.a)().getUserIds = Q),
              (Object(u.a)().getUserIdsAsEids = X),
              (Object(u.a)().refreshUserIds = Y));
      }
      re(a.b),
        Object(f.c)('userId', oe),
...
var jppol = (function (exports) {
  ...
  var BidderHandler = function (bannerObject, keywords, eidsAllowed) {
    try {
      ...
      return __spreadArray(
        __spreadArray(__spreadArray([], adformBids, true), appnexusBids, true),
        criteoBids,
        true
      );
    } catch (err) {
  ...
  function AdUnitCreator(bannerContainer, keywords, eidsAllowed) {
    try {
      var adUnits = [];
      for (
        var _i = 0, bannerContainer_1 = bannerContainer;
        _i < bannerContainer_1.length;
        _i++
      ) {
      ...
      if (returnObj[key]) {
        if (typeof returnObj[key] === typeof obj2[key]) {
          if (Array.isArray(obj2[key])) {
            returnObj[key] = __spreadArray(
              __spreadArray([], returnObj[key], true),
              obj2[key],
              true
            );
          } else if (
  ...
  var AuctionHandler = (function () {
    ...
    AuctionHandler.prototype.add = function (options) {
      ...
      this.waitformoreAllowed =
        (_a = options.allowWait) !== null && _a !== void 0
          ? _a
          : this.waitformoreAllowed;
      if (options.banners) {
    ...
    AuctionHandler.prototype.auction = function () {
      ...
      try {
        ...
        var _a = this.auctionSettings,
          adserverCallback_1 = _a.adserverCallback,
          banners = _a.banners,
          consentTimeout_1 = _a.consentTimeout,
          debug_1 = _a.debug,
          eidsAllowed = _a.eidsAllowed,
          keywords = _a.keywords,
          timeout_1 = _a.timeout;
            ...
            pbjs_1.requestBids({
              bidsBackHandler: function (bidResponse) {
                ...
                console.log(
                  ...
                  pbjs_1.getAdserverTargeting()
                );
                var apntag = window.apntag;
                if (typeof apntag !== 'undefined') {
                  pbjs_1.que.push(function () {
                    console.log(
                      'prebid: bidsBackHandler adding apn to pbjs que'
                    );
  ...
  var _a;
  window[PREBIDAUCTION] =
    window[PREBIDAUCTION] || ((_a = {}), (_a[COMPLETED] = true), _a);
